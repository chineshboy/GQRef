 ...
 *
 * Konstantinos A. Nedas Department of Spatial Information Science & Engineering
 * University of Maine, Orono, ME 04469-5711, USA kostas@spatial.maine.edu
 ...
 * It takes 2 arguments: a. A 2-D array (could be rectangular or square). b. A
 * string ("min" or "max") specifying whether you want the min or max
 * assignment. [It returns an assignment matrix[array.length][2] that contains
 * the row and col of the elements (in the original inputted array) that make up
 ...
 * (http://www.spatial.maine.edu/~kostas/dev/soft/munkres.htm)]
 *
 * Any comments, corrections, or additions would be much appreciated. Credit due
 * to professor Bob Pilgrim for providing an online copy of the pseudocode for
 * this algorithm (http://216.249.163.93/bob.pilgrim/445/munkres.html)
 *
 * Feel free to redistribute this source code, as long as this header--with the
 * exception of sections in brackets--remains as part of the file.
 *
 * Requirements: JDK 1.5.0_01 or better. [Created in Eclipse 3.1M6
 * (www.eclipse.org).]
 *
 */
